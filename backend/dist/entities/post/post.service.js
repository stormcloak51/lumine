...
const user_constants_1 = require("../../infrastructure/config/constants/user.constants");
...
let PostService = class PostService {
    ...
    async delete(postId, userId) {
        ...
        try {
            ...
            throw new common_1.BadRequestException('Failed to delete post and its related data');
        }
    }
    async edit(data) {
        if (!data.postId)
